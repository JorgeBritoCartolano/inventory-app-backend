...
public class ReportServiceImpl implements ReportService {
    ...
    public File generateInventoryReport() throws IOException {
        ...
        File reportFile = File.createTempFile(generateUniqueFileName("inventory/inventory-report"), ".csv");
    ...
    public File generateTransactionHistoryReport() throws IOException {
        ...
        File reportFile = File.createTempFile(generateUniqueFileName("transactions/transaction-history"), ".csv");
